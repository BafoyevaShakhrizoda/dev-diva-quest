...
const Auth = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = e.data;
      let msg = e.message || t("auth.errGeneric");
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden gradient-primary flex-col items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="mt-10 grid grid-cols-3 gap-4">
            {[
              { value: "15+", label: t("auth.statPaths") },
              { value: "3", label: t("auth.statLevels") },
              { value: "100+", label: t("auth.statQuestions") },
            ].map((stat) => (
              <div
                key={stat.label}
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h1 className="font-display text-3xl font-bold text-foreground mb-2">
              {mode === "login" ? t("auth.welcomeLogin") : t("auth.joinTitle")}
            </h1>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={mode === "register" ? t("auth.phPassRegister") : t("auth.phPassLogin")}
                  value={password}
